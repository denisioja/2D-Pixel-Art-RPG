...
public class Entity { // stores variables that will be used in player, monster and NPC classes
    ...
    public BufferedImage up1, up2, down1, down2, left1, left2, right1, right2; //it describes an image with an accessible buffer of image data. (to store the image files)
    public BufferedImage attack_up1, attack_up2, attack_down1, attack_down2, attack_left1, attack_left2, attack_right1, attack_right2, guardUp, guardDown, guardLeft, guardRight;
    public Rectangle solidArea = new Rectangle(0, 0, 48, 48); //the solid part of our character (collision)
    public Rectangle attackArea = new Rectangle(0, 0, 0, 0); // the area is determined of the weapon used
    ...
    public String direction = "down"; // the default direction for objects
    ...
    public int life;
    public int maxAmmo;
    public int ammo; // the og is mana
    public int stones; // the og is ammo
    public int level;
    public int strength;
    ...
    public int defense;
    public int exp;
    public int nextLevelExp; // The exp required for the next level
    public int coin;
    ...
    public void dropItem(Entity droppedItem) {
        for(int i =0; i < gp.obj[1].length; i++) {
            if(gp.obj[gp.currentMap][i] == null) {
                ...
                break; // once we find an empty slot we stop, else the item will be put in all the empty slots
            }
        }
    }
    ...
    public int getParticleMaxLife() {
        int maxLife = 0; // It shows how much the particle lasts
        return maxLife;
    }
    ...
    public void checkCollision() {
        ...
        if(this.type == type_monster && contactPlayer == true) { // Monster && touched player
            damagePlayer(attack);
        }
    }

    public void update() { //that's for all the npc's
        ...
        if (invincible == true) {
            invincibleCounter++;
            if (invincibleCounter > 40) { // One second
                invincible = false;
                invincibleCounter = 0;
        ...
        if(shotAvailableCounter < 30) { // if you shoot a Spear, you can't shoot an other one for the next 30 frames
...
//                gp.projectileList.add(projectile);
    ...
    public void attacking() {
        ...
        if (spriteCounter> motion1_duration && spriteCounter <= motion2_duration) {
            spriteNum = 2;
            // we need to check the collision with the player's weapon, not the player actual position
...
//                gp.playSE(6);
    ...
    public void draw(Graphics2D g2) {
        ...
        if(worldX + gp.tileSize > gp.player.worldX - gp.player.screenX &&
            ...
            if (type == 2 && hpBarOn == true) {
                ...
                double oneScale = (double)gp.tileSize/maxLife; // it divides the bar in units
                ...
                if(hpBarCounter > 600) { // after 10 seconds the bar disappears
                    hpBarCounter = 0;
                    hpBarOn = false;
                }
            }
    ...
    public void dyingAnimation(Graphics2D g2) {
        dyingCounter++;
        int i = 5;
        // every 5 frames we change it's transparecy and it blinks
        if (dyingCounter <= i) {
            changeAlpha(g2, 0f);
        }
